...
import 'package:flutter_tmdb/bloc/get_now_airing_bloc.dart';
...
class NowAiring extends StatefulWidget {
  @override
  _NowAiringState createState() => _NowAiringState();
}

class _NowAiringState extends State<NowAiring> {
  PageController pageController = PageController(viewportFraction: 1, keepPage: true);

  @override
  void initState() {
    super.initState();
    nowAiringMoviesBloc.getAiringMovies();
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TvResponse>(
      stream: nowAiringMoviesBloc.subject.stream,
                    ...
                    Positioned(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              movies[index].title == null? Text("No Title",style: TextStyle(color: Colors.white70),) :
                              Text(
                                movies[index].title,
                                style: TextStyle(
                                    height: 1.5,
