...
import 'package:flutter_tmdb/bloc/get_casts_bloc.dart';
import 'package:flutter_tmdb/model/cast.dart';
import 'package:flutter_tmdb/model/cast_response.dart';
import 'package:flutter_tmdb/style/theme.dart' as Style;
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class Comapnies extends StatefulWidget {
  final int id;

  const Comapnies({Key key, this.id}) : super(key: key);

  @override
  _ComapniesState createState() => _ComapniesState(id);
}

class _ComapniesState extends State<Comapnies> {
  final int id;

  _ComapniesState(this.id);
