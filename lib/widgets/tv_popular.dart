...
import 'package:flutter_tmdb/bloc/get_tv_popular_bloc.dart';
...
class TvPopularMovies extends StatefulWidget {
  @override
  _TvPopularMoviesState createState() => _TvPopularMoviesState();
}

class _TvPopularMoviesState extends State<TvPopularMovies> {
  @override
  void initState() {
    super.initState();
