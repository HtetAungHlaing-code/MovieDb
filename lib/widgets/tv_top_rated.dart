...
import 'package:flutter_tmdb/bloc/get_tv_top_rated_bloc.dart';
...
class TvTopRatedMovies extends StatefulWidget {
  @override
  _TvTopRatedMoviesState createState() => _TvTopRatedMoviesState();
}

class _TvTopRatedMoviesState extends State<TvTopRatedMovies> {
  @override
  void initState() {
    super.initState();
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text("TOP RATED SHOWS",style: TextStyle(
